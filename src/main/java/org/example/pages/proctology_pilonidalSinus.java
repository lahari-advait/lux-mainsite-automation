...
public class proctology_pilonidalSinus {
    WebDriver driver;
    WebDriverWait wait;
    Actions actions;

    public static void main(String[] args) throws InterruptedException {
        proctology_pilonidalSinus test = new proctology_pilonidalSinus();
        test.setUp();
        test.hoverTreatments();
        test. clickPilonidalSinusTreatment();
        Thread.sleep(1000);
    ...
    public void clickPilonidalSinusTreatment() {
        WebElement pilonidalSinusLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[text()='Pilonidal Sinus']/ancestor::a")));
        pilonidalSinusLink.click();
        System.out.println("💊 Clicked on 'Pilonidal Sinus' treatment");
    }

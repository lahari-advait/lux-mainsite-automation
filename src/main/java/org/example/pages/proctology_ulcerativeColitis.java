...
public class proctology_ulcerativeColitis {
    WebDriver driver;
    WebDriverWait wait;
    Actions actions;

    public static void main(String[] args) throws InterruptedException {
        proctology_ulcerativeColitis test = new proctology_ulcerativeColitis();
        test.setUp();
        test.hoverTreatments();
        test. clickUlcerativeColitisTreatment();
        Thread.sleep(1000);
    ...
    public void clickUlcerativeColitisTreatment() {
        WebElement ulcerativeColitisLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[text()='Ulcerative Colitis']/ancestor::a")));
        ulcerativeColitisLink.click();
        System.out.println("💊 Clicked on 'Ulcerative Colitis' treatment");
    }

...
public class gastroObstructiveDefecationSyndrome {
    ...
    private By odsLink = By.xpath("//a[contains(text(), 'Obstructive Defecation Syndrome (ODS)')]");

    public gastroObstructiveDefecationSyndrome(WebDriver driver) {
        this.driver = driver;
        this.allTreatments = new allTreatments(driver);
    }

    // ✅ Full flow: Treatments → Gastroenterology → Obstructive Defecation Syndrome
    public void hoverAndOpen() throws InterruptedException {
        ...
        allTreatments.clickSpecificTreatment("Obstructive Defecation Syndrome (ODS)");

        System.out.println("✅ Opened Gastroenterology → Obstructive Defecation Syndrome treatment page");
        Thread.sleep(1500);
    }

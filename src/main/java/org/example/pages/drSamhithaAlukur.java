...
public class drSamhithaAlukur {

    private WebDriver driver;
    private String parentWindow;
    public allDoctorCards allDoctorCards;

    public drSamhithaAlukur(WebDriver driver) {
        this.driver = driver;
...
//        allDoctorCards.openHomePage();
        ...
        allDoctorCards.viewDoctorProfile("Dr. Samhitha Alukur");
    ...
    public void clickParentWhatsAppButton1() throws InterruptedException {
        allDoctorCards.clickParentWhatsAppButtonForDoctor("Dr. Samhitha Alukur");
    }
}

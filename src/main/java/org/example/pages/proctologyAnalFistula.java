...
public class proctologyAnalFistula {

    private WebDriver driver;
    private String parentWindow;
    public allTreatments allTreatments;
    
    // Locators (kept for reference, though allTreatments handles these)
    ...
    private By analFistulaLink = By.xpath("//a[contains(text(), 'Anal Fistula')]");

    public proctologyAnalFistula(WebDriver driver) {
        this.driver = driver;
        this.allTreatments = new allTreatments(driver);
    }

    // ✅ Full flow: Treatments → Proctology → Anal Fistula
    public void hoverAndOpen() throws InterruptedException {
        ...
        allTreatments.clickSpecificTreatment("Anal Fistula");

        System.out.println("✅ Opened Proctology → Anal Fistula treatment page");
        Thread.sleep(1500);
    }

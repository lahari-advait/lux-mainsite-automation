...
public class proctology_fecalIncontinence {
    WebDriver driver;
    WebDriverWait wait;
    Actions actions;

    public static void main(String[] args) throws InterruptedException {
        proctology_fecalIncontinence test = new proctology_fecalIncontinence();
        test.setUp();
        test.hoverTreatments();
        test.clickFecalIncontinenceTreatment();
        Thread.sleep(1000);
    ...
    public void clickFecalIncontinenceTreatment() {
        WebElement fecalIncontinenceLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[text()='Fecal Incontinence']/ancestor::a")));
        fecalIncontinenceLink.click();
        System.out.println("💊 Clicked on 'Fecal Incontinence' treatment");
    }

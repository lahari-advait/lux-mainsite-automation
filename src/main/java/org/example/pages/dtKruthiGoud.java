...
public class dtKruthiGoud {

    private WebDriver driver;
    private String parentWindow;
    public allDoctorCards allDoctorCards;

    public dtKruthiGoud(WebDriver driver) {
        this.driver = driver;
...
//        allDoctorCards.openHomePage();
        ...
        allDoctorCards.viewDoctorProfile("Dt. Kruthi Goud");
    ...
    public void clickParentWhatsAppButton1() throws InterruptedException {
        allDoctorCards.clickParentWhatsAppButtonForDoctor("Dt. Kruthi Goud");
    }
}

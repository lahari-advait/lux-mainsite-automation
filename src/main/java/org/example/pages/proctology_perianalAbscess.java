...
public class proctology_perianalAbscess {
    ...
    public static void main(String[] args) throws InterruptedException {
        proctology_perianalAbscess test = new proctology_perianalAbscess();
        test.setUp();
        test.hoverTreatments();
        test. clickperianalAbscessTreatment();
        Thread.sleep(1000);
    ...
    public void clickperianalAbscessTreatment() {
        WebElement perianalAbscessLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[text()='Rectal Prolapse']/ancestor::a")));
        perianalAbscessLink .click();
        System.out.println("💊 Clicked on 'Perianal Abscess' treatment");
    }

...
public class proctologyAnalFissure {

    private WebDriver driver;
    private String parentWindow;
    public allTreatments allTreatments;

    // Locators (for reference, though allTreatments handles these)
    ...
    private By analFissureLink = By.xpath("//a[contains(text(), 'Anal Fissure')]");

    public proctologyAnalFissure(WebDriver driver) {
        this.driver = driver;
        this.allTreatments = new allTreatments(driver);
    }

    // ✅ Full flow: Treatments → Proctology → Anal Fissure
    public void hoverAndOpen() throws InterruptedException {
        ...
        allTreatments.clickSpecificTreatment("Anal Fissure");

        System.out.println("✅ Opened Proctology → Anal Fissure treatment page");
        Thread.sleep(1500);
    }

...
public class drMadhanMohan {

    private WebDriver driver;
    private String parentWindow;
    public allDoctorCards allDoctorCards;

    public drMadhanMohan(WebDriver driver) {
        this.driver = driver;
...
//        allDoctorCards.openHomePage();
        ...
        allDoctorCards.viewDoctorProfile("Dr. Madhan Mohan");
    ...
    public void clickParentWhatsAppButton1() throws InterruptedException {
        allDoctorCards.clickParentWhatsAppButtonForDoctor("Dr. Madhan Mohan");
    }
}

...
public class proctology_chronicConstipation {
    WebDriver driver;
    WebDriverWait wait;
    Actions actions;

    public static void main(String[] args) throws InterruptedException {
        proctology_chronicConstipation test = new proctology_chronicConstipation();
        test.setUp();
        test.hoverTreatments();
        test. clickChronicConstipationTreatment() ;
        Thread.sleep(1000);
    ...
    public void clickChronicConstipationTreatment() {
        WebElement chronicConstipationLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[text()='Chronic Constipation']/ancestor::a")));
        chronicConstipationLink.click();
        System.out.println("💊 Clicked on 'Chronic Constipation' treatment");
    }

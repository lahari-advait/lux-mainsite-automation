...
public class proctology_inflammatoryBoweldisease {
    WebDriver driver;
    WebDriverWait wait;
    Actions actions;

    public static void main(String[] args) throws InterruptedException {
        proctology_inflammatoryBoweldisease test = new proctology_inflammatoryBoweldisease();
        test.setUp();
        test.hoverTreatments();
        test. clickInflammatoryBowelDiseaseTreatment();
        Thread.sleep(1000);
    ...
    public void clickInflammatoryBowelDiseaseTreatment() {
        WebElement ibdLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[text()='Inflammatory Bowel Disease']/ancestor::a")));
        ibdLink.click();
        System.out.println("💊 Clicked on 'Inflammatory Bowel Disease' treatment");
    }

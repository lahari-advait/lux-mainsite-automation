...
public class drAbhishek {

    private WebDriver driver;
    private String parentWindow;
    public allDoctorCards allDoctorCards;

    public drAbhishek(WebDriver driver) {
        this.driver = driver;
...
//        allDoctorCards.openDoctorsPage();
        allDoctorCards.viewDoctorProfile("Dr. Abhishek Katha");
    ...
    public void clickParentWhatsAppButton1() throws InterruptedException {
        allDoctorCards.clickParentWhatsAppButtonForDoctor("Dr. Abhishek Katha");
    }
}

...
public class proctology_analfistula {
    ...
    public static void main(String[] args) throws InterruptedException {
        proctology_analfistula test = new proctology_analfistula();
        test.setUp();
        test.hoverTreatments();
        test.clickAnalFistulaTreatment();
        Thread.sleep(1000);
    ...
    public void clickAnalFistulaTreatment() {
        WebElement link = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[contains(text(),'Anal Fistula')]")));
        link.click();
        System.out.println("💊 Clicked on 'Anal Fistula' treatment");
    }

...
public class proctology_ObstructiveDefecationSyndrome {
    WebDriver driver;
    WebDriverWait wait;
    Actions actions;

    public static void main(String[] args) throws InterruptedException {
        proctology_ObstructiveDefecationSyndrome test = new proctology_ObstructiveDefecationSyndrome();
        test.setUp();
        test.hoverTreatments();
        test.clickObstructiveDefecationSyndromeTreatment();
        Thread.sleep(1000);
    ...
    public void clickObstructiveDefecationSyndromeTreatment() {
        WebElement odsLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[text()='Obstructive Defecation Syndrome']/ancestor::a")));
        odsLink.click();
        System.out.println("💊 Clicked on 'Obstructive Defecation Syndrome' treatment");
    }

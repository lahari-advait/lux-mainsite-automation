...
public class drPallaviPallapu {

    private WebDriver driver;
    private String parentWindow;
    public allDoctorCards allDoctorCards;

    public drPallaviPallapu(WebDriver driver) {
        this.driver = driver;
    ...
    public void openProfileAndBookAppointment() throws InterruptedException {
        ...
        allDoctorCards.viewDoctorProfile("Dr. Pallavi Pallapu");
    ...
    public void clickParentWhatsAppButton1() throws InterruptedException {
        allDoctorCards.clickParentWhatsAppButtonForDoctor("Dr. Pallavi Pallapu");
    }
}

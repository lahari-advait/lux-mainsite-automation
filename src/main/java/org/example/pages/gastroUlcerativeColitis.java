...
public class gastroUlcerativeColitis {
    ...
    private By ulcerativeColitisLink = By.xpath("//a[contains(text(), 'Ulcerative Colitis')]");

    public gastroUlcerativeColitis(WebDriver driver) {
        this.driver = driver;
        this.allTreatments = new allTreatments(driver);
    }

    // ✅ Full flow: Treatments → Gastroenterology → Ulcerative Colitis
    public void hoverAndOpen() throws InterruptedException {
        ...
        allTreatments.clickSpecificTreatment("Ulcerative Colitis");

        System.out.println("✅ Opened Gastroenterology → Ulcerative Colitis treatment page");
        Thread.sleep(1500);
    }

...
public class proctology_rectalproplase {
    ...
    public static void main(String[] args) throws InterruptedException {
        proctology_rectalproplase test = new proctology_rectalproplase();
        test.setUp();
        test.hoverTreatments();
        test. clickRectalProlapseTreatment();
        Thread.sleep(1000);
    ...
    public void clickRectalProlapseTreatment() {
        WebElement rectalProlapseLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[text()='Rectal Prolapse']/ancestor::a")));
        rectalProlapseLink.click();
        System.out.println("💊 Clicked on 'Rectal Prolapse' treatment");
    }

...
public class gastroIrritableBowelSyndrome {
    ...
    private By ibsLink = By.xpath("//a[contains(text(), 'Irritable Bowel Syndrome')]");

    public gastroIrritableBowelSyndrome(WebDriver driver) {
        this.driver = driver;
        this.allTreatments = new allTreatments(driver);
    }

    // ✅ Full flow: Treatments → Gastroenterology → IBS
    public void hoverAndOpen() throws InterruptedException {
        ...
        allTreatments.clickSpecificTreatment("Irritable Bowel Syndrome");

        System.out.println("✅ Opened Gastroenterology → Irritable Bowel Syndrome treatment page");
        Thread.sleep(1500);
    }

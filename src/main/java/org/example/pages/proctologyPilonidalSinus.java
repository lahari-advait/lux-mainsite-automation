...
public class proctologyPilonidalSinus {
    ...
    private By pilonidalSinusLink = By.xpath("//a[contains(text(), 'Pilonidal Sinus')]");

    public proctologyPilonidalSinus(WebDriver driver) {
        this.driver = driver;
        this.allTreatments = new allTreatments(driver);
    }

    // ✅ Full flow: Treatments → Proctology → Pilonidal Sinus
    public void hoverAndOpen() throws InterruptedException {
        ...
        allTreatments.clickSpecificTreatment("Pilonidal Sinus");

        System.out.println("✅ Opened Proctology → Pilonidal Sinus treatment page");
        Thread.sleep(1500);
    }

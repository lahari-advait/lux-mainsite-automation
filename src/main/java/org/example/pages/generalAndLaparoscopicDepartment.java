...
public class generalAndLaparoscopicDepartment {

    private WebDriver driver;
    private ourDepartments departmentsPage;

    public generalAndLaparoscopicDepartment(WebDriver driver) {
        this.driver = driver;
    ...
    public void open() {
        By deptLocator = By.xpath("//div[h2[text()='General and Laparoscopic']]");
        ...
        System.out.println("✅ Opened the General and Laparoscopic Department page.");
    }

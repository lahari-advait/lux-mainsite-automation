...
public class drPPragnia {

    private WebDriver driver;
    private String parentWindow;
    public allDoctorCards allDoctorCards;

    public drPPragnia(WebDriver driver) {
        this.driver = driver;
        this.allDoctorCards = new allDoctorCards(driver);
    }

    // ✅ Main flow: homepage → doctors → profile → book appointment (stay on child)
...
//        allDoctorCards.openHomePage();
        ...
        allDoctorCards.viewDoctorProfile("Dr. P Pragnia");

        // Switch to doctor profile tab
        allDoctorCards.switchToNewWindow();

        // Click Book Appointment (opens WhatsApp tab, closes it, stay on child)
    ...
    public void clickParentWhatsAppButton1() throws InterruptedException {
        allDoctorCards.clickParentWhatsAppButtonForDoctor("Dr. P Pragnia");
    }
}

...
public class proctology_pelvicFloorDysfunction {
    WebDriver driver;
    WebDriverWait wait;
    Actions actions;

    public static void main(String[] args) throws InterruptedException {
        proctology_pelvicFloorDysfunction test = new proctology_pelvicFloorDysfunction();
        test.setUp();
        test.hoverTreatments();
        test. clickPelvicFloorDysfunctionTreatment();
        Thread.sleep(1000);
    ...
    public void clickPelvicFloorDysfunctionTreatment() {
        WebElement pelvicFloorLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[text()='Pelvic Floor Dysfunction']/ancestor::a")));
        pelvicFloorLink.click();
        System.out.println("💊 Clicked on 'Pelvic Floor Dysfunction' treatment");
    }

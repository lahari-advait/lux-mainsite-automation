...
public class proctology_analPolypRemoval {
    ...
    public static void main(String[] args) throws InterruptedException {
        proctology_analPolypRemoval test = new proctology_analPolypRemoval();
        test.setUp();
        test.hoverTreatments();
        test. clickAnalPolypRemovalTreatment();
        Thread.sleep(1000);
    ...
    public void clickAnalPolypRemovalTreatment() {
        WebElement analPolypLink = wait.until(ExpectedConditions.elementToBeClickable(
            By.xpath("//p[text()='Anal Polyp Removal']/ancestor::a")));
        analPolypLink.click();
        System.out.println("💊 Clicked on 'Anal Polyp Removal' treatment");
    }

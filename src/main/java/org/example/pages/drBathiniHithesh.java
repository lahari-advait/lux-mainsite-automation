...
public class drBathiniHithesh {

    private WebDriver driver;
    private String parentWindow;
    public allDoctorCards allDoctorCards;

    public drBathiniHithesh(WebDriver driver) {
        this.driver = driver;
        this.allDoctorCards = new allDoctorCards(driver);
    }

    // ✅ Main flow: homepage -> doctors page -> profile -> book appointment
...
//        allDoctorCards.openHomePage();
        ...
        allDoctorCards.viewDoctorProfile("Dr. Bathini Hithesh");

        // Switch to child profile window
    ...
    public void clickParentWhatsAppButton1() throws InterruptedException {
        allDoctorCards.clickParentWhatsAppButtonForDoctor("Dr. Bathini Hithesh");
    }
}

...
public class DrNaveenchandra {

    private WebDriver driver;
    private String parentWindow;
    public allDoctorCards allDoctorCards;

    public DrNaveenchandra(WebDriver driver) {
        this.driver = driver;
    ...
    public void openProfileAndBookAppointment() throws InterruptedException {
        ...
        allDoctorCards.viewDoctorProfile("Dr. Naveenchandra");
    ...
    public void clickParentWhatsAppButton1() throws InterruptedException {
        allDoctorCards.clickParentWhatsAppButtonForDoctor("Dr. Naveenchandra");
    }
}

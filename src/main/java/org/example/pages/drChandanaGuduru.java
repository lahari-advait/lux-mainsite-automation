...
public class drChandanaGuduru {

    private WebDriver driver;
    private String parentWindow;
    public allDoctorCards allDoctorCards;

    public drChandanaGuduru(WebDriver driver) {
        this.driver = driver;
...
//        allDoctorCards.openHomePage();
        ...
        allDoctorCards.viewDoctorProfile("Dr. Chandana Guduru");
    ...
    public void clickParentWhatsAppButton1() throws InterruptedException {
        allDoctorCards.clickParentWhatsAppButtonForDoctor("Dr. Chandana Guduru");
    }
}
